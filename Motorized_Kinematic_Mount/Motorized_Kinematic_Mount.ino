/*
  ...
  Description: 
  Program that allows to measure voltage and to control TEN stepper motors (28BYJ-48) connected to an 
  ...
  Modified 4 / June / 2019 by Maciej Kościelski (measuring voltage)
...
//  Serial.println(String(commandString.substring(11).toInt()+10));
  ...
  // voltage
  if(commandString.substring(0,4) == "VOLT"){  
